...
$(document).on('click', "#todosPedidos", function(){
    ...
    $.ajax({
        url: `http://127.0.0.1:5500/View/Pedidos/TodosPedidos.html`,
        type: "GET",
        success: function (data) {
            $("#pageContent #rowPageContent").append(data) 
            listarTodosPedidos()
...
$(document).on('click', "#incluirBebida", function(){
    ...
    $.ajax({
        url: `http://127.0.0.1:5500/View/Bebidas/IncluirBebida.html`,
        type: "GET",
        success: function (data) {
            $("#pageContent #rowPageContent").append(data) 
...
$(document).on('click', "#incluirCategoria", function(){
    ...
    $.ajax({
        url: `http://127.0.0.1:5500/View/Categoria/IncluirCategoria.html`,
        type: "GET",
        success: function (data) {
            $("#pageContent #rowPageContent").append(data) 
            //alert("Bebida incluída com sucesso!");
...
$(document).on('click', "#alterarCategoria", function(){
    ...
    $.ajax({
        url: `http://127.0.0.1:5500/View/Categoria/Categoria.html`,
        type: "GET",
        success: function (data) {
            $("#pageContent #rowPageContent").append(data) 
            carregarCategorias()
